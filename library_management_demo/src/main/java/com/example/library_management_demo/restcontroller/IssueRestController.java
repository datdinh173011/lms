...
import com.example.library_management_demo.service.IssueService;
import com.example.library_management_demo.service.IssuedBookService;
...
public class IssueRestController {
    ...
    public String save(@RequestParam Map<String, String> payload) {
        ...
        for( int k=0 ; k<books.size() ; k++ ) {
            ...
            book.setStatus( BOOK_STATUS_ISSUED );
    ...
    public String returnAll(@PathVariable(name = "id") Long id) {
        ...
        if( issue != null ) {
            ...
            issue.setReturned( BOOK_RETURNED );
