...
import com.example.library_management_demo.repository.BookRepository;
...
import static com.example.library_management_demo.common.Constants.BOOK_STATUS_AVAILABLE;
import static com.example.library_management_demo.common.Constants.BOOK_STATUS_ISSUED;
...
public class BookService {
    ...
    public Long getTotalIssuedBook(){
        return bookRepository.countByStatus(BOOK_STATUS_ISSUED);
    }
    ...
    public List<Book> geAvailabletByCategory(Category category) {
        return bookRepository.findByCategoryAndStatus(category, BOOK_STATUS_AVAILABLE);
    }
